...
use App\Models\ReservasiClient;
...
class ReservasiController extends Controller
{
    ...
    {
        //menampilkan data reservasi client
    $pelanggan = Pelanggan::where('id_user', '=', Auth::user()->id)->get();
    $idpelanggan = $pelanggan[0]['id'];
    $reservasi = ReservasiClient::where('id_pelanggan', '=', $idpelanggan)->get();
    return view('reservasiclient.index', [
        'reservasi' => $reservasi
    ]);
    }
