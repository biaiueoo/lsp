                        ...
                        <table class="table table-hover table-bordered table-stripped" id="example2">
                            ...
                            @foreach($paket_wisata as $key => $data)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('paket_wisata.edit', $data)}}" class="btn btn-primary btn-xs">
                                            Edit
                                        </a>
                                        <a href="{{route('paket_wisata.destroy', $data)}}" onclick="notificationBeforeDelete(event, this)" class="btn btn-danger btn-xs">
                                            Delete
                                        </a>
                                    </td>
                                </tr>
